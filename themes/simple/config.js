const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>Digital nomad wandering in Codes.<br/>QA by sunrise, trekking by twilight.<br/>Punk spirit + Outdoor soul</div>',
